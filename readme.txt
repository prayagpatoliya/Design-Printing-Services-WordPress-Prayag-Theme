== Alpha Color ==
Version: 1.4.7
Copyright: 2023, ThemeREX
WordPress version: required at least 4.5, tested up to 6.2.0
...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Alpha Color'.
Please install and activate it before starting to use the theme Alpha Color.
...
Theme documentation is available on https://alpha-color.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Alpha Color is Fontello.
